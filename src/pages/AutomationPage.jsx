...
const DEFAULT_WORKFLOWS = [
  ...
  {
    key: 'sales_listing_enquiry',
    title: 'Sales Listing — Enquiry Response',
    module: 'sales',
    automationMode: 'hybrid',
    steps: [
      { label: 'Enquiry received (portal / email / phone)', canAutomate: true },
      { label: 'AI scores lead intent', canAutomate: true },
      { label: 'Personalised reply drafted', canAutomate: true },
      { label: 'Reply sent to buyer', requiresApproval: true },
      { label: 'Inspection booking offered', canAutomate: true },
      { label: 'Inspection confirmation sent', canAutomate: true },
      { label: 'Documents shared on request', requiresApproval: true },
    ]
  },
  {
    key: 'sales_listing_inspection',
    title: 'Sales Listing — Inspection Follow-Up',
    module: 'sales',
    automationMode: 'hybrid',
    steps: [
      { label: 'Inspection reminder sent (24h prior)', canAutomate: true },
      { label: 'Attendance recorded post-inspection', canAutomate: false },
      { label: 'Follow-up message drafted and sent', requiresApproval: true },
      { label: 'Feedback requested from buyer', canAutomate: true },
      { label: 'Offer intent scored', canAutomate: true },
      { label: 'Lead moved to high-intent pipeline if score ≥80', canAutomate: true },
    ]
  },
  {
    key: 'sales_auction',
    title: 'Sales Listing — Auction Engagement',
    module: 'sales',
    automationMode: 'approval',
    steps: [
      { label: 'Auction registration opened', canAutomate: true },
      { label: 'Bidder confirmation sent', canAutomate: true },
      { label: 'Pre-auction offer follow-up', requiresApproval: true },
      { label: 'Auction result communication to all parties', requiresApproval: true },
      { label: 'Unsuccessful bidder re-engagement', requiresApproval: true },
    ]
  },
  {
    key: 'crm_initial_outreach',
    title: 'CRM — Initial Re-Engagement Outreach',
    module: 'sales',
    automationMode: 'approval',
    steps: [
      { label: 'Contact imported and AI scored', canAutomate: true },
      { label: 'Signal generated based on data richness', canAutomate: true },
      { label: 'Personalised first-touch message drafted', canAutomate: true },
      { label: 'Message queued for approval', requiresApproval: true },
      { label: 'Message sent via preferred channel', requiresApproval: true },
      { label: 'Reply triaged — warmth score updated', canAutomate: true },
    ]
  },
  {
    key: 'crm_requalification_invite',
    title: 'CRM — Re-Qualification via Seek to Sold Invite',
    module: 'sales',
    automationMode: 'hybrid',
    steps: [
      { label: 'Contact flagged for re-qualification', canAutomate: true },
      { label: 'Personalised invite email drafted', canAutomate: true },
      { label: 'Invite sent to contact', requiresApproval: true },
      { label: 'Onboarding completion tracked', canAutomate: true },
      { label: 'Intent, budget, timeline synced back to CRM', canAutomate: true },
      { label: 'Signal queue updated with fresh data', canAutomate: true },
    ]
  },
  {
    key: 'crm_comparable_sales',
    title: 'CRM — Comparable Sale / Market Update',
    module: 'sales',
    automationMode: 'hybrid',
    steps: [
      { label: 'New comparable sale detected in contact area', canAutomate: true },
      { label: 'Relevance scored against contact profile', canAutomate: true },
      { label: 'Market update message drafted', canAutomate: true },
      { label: 'Sent if auto-mode and score ≥ threshold', requiresApproval: true },
      { label: 'Engagement tracked (open / click / reply)', canAutomate: true },
    ]
  },
  {
    key: 'crm_investor_brief',
    title: 'CRM — Investor Property Brief',
    module: 'sales',
    automationMode: 'approval',
    steps: [
      { label: 'Investment-grade property listed or matched', canAutomate: true },
      { label: 'Investor contact identified from CRM', canAutomate: true },
      { label: 'Investment brief report generated by AI', canAutomate: true },
      { label: 'Brief reviewed and approved by agent', requiresApproval: true },
      { label: 'Brief sent to investor', requiresApproval: true },
      { label: 'Follow-up scheduled if no reply in 5 days', canAutomate: true },
    ]
  },
];
